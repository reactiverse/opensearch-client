...
class ShimMaker extends VoidVisitorAdapter<Void> {
  ...
  public void visit(ClassOrInterfaceDeclaration n, Void arg) {
    ...
    String delegateType = "org.opensearch.client." + n.getNameAsString();
  ...
  public void visit(ConstructorDeclaration n, Void arg) {
    if (n.isPublic()) {
      ...
      String constructorArgs = parameters
        ...
        .collect(Collectors.joining(", "));
      constructorBlock
        .addStatement(JavaParser.parseStatement("this.delegate = new org.opensearch.client." + shimInterface.getNameAsString() + "(" + constructorArgs + ");"));

      shimImplementation
        .addField("org.opensearch.client." + shimInterface.getNameAsString(), "delegate")
        .setPrivate(true)
        .setFinal(true);
    }
    super.visit(n, arg);
